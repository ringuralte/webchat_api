...
var Home = function Home() {
  ...
  var _React$useContext = react__WEBPACK_IMPORTED_MODULE_3___default.a.useContext(_components_Store__WEBPACK_IMPORTED_MODULE_7__["storeCTX"]),
      newLink = _React$useContext.newLink,
      setTopic = _React$useContext.setTopic;

  react__WEBPACK_IMPORTED_MODULE_3___default.a.useEffect(function () {
    isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_13___default()("http://localhost:5000/checkToken", {
      credentials: "include"
    }).then(function (res) {
      return res.json();
  ...
  return __jsx(_components_Layout__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    __self: this
  }, "Just Another Chat App"), __jsx(_material_ui_core_List__WEBPACK_IMPORTED_MODULE_10__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 54
    },
    ...
    return __jsx(_material_ui_core_ListItem__WEBPACK_IMPORTED_MODULE_11__["default"], {
      button: true,
      key: key,
      onClick: function onClick() {
        //for the useEffect fetch on [id].js
        window.localStorage.setItem("topic", _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(newLink[key].title)); // setTopic(newLink[key]);
      },
      __source: {
        fileName: _jsxFileName,
        lineNumber: 56
...
//# sourceMappingURL=index.js.ece1280c9a87520d5b05.hot-update.js.map