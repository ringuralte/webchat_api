  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    fetch("http://localhost:5000/api/postChat", {
      ...
      if (json.code === 401) {
        ...
        console.log(_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(json.id).map(function (key) {
          return key;
        }));
...
//# sourceMappingURL=[id].js.0e0c0cd7b6b0e8dc27fd.hot-update.js.map