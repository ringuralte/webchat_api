  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    fetch("http://localhost:5000/api/postChat", {
      ...
      if (json.code === 401) {
        ...
        console.log(_babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_0___default()(json).map(function (key) {
          return key;
        }));
...
//# sourceMappingURL=[id].js.2bc5fdb2ab667b094214.hot-update.js.map