  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    fetch("http://localhost:5000/api/postChat", {
      ...
      if (json.code === 401) {
        ...
        console.log(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(json.id)); // sendChatAction({
        //   id: json.id,
...
//# sourceMappingURL=[id].js.cd2f39f46f8172021412.hot-update.js.map